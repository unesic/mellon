...
const Log = ({
	...
	return (
		<div className="DailyTracking__Log">
			<LogCreatedAt editing={editing} timestamp={createdAt} idx={idx} />
			<LogType
				type={logState.typeId}
				types={logTypes}
			...
			<LogSubType
				type={logState.typeId}
				subtype={logState.subtypeId}
				subtypes={logSubTypes}
				change={onLogSubTypeChange}
				editing={editing}
				data={{
			...
			/>
			<LogAdditional
				change={onLogAdditionalChange}
				editing={editing}
				subtype={logState.subtypeId}
				text={logState.additional}
				idx={idx}
			/>
			<LogTime
